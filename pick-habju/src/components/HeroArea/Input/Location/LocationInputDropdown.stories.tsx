...
const LOCATION_OPTIONS: LocationOption[] = [
  { id: 'isuyeok', name: '이수역', subwayLine: '4호선·7호선' },
  { id: 'sangdo', name: '상도역', subwayLine: '7호선' },
  { id: 'sadang', name: '사당역', subwayLine: '2호선·4호선' },
  { id: 'heukseok', name: '흑석역', subwayLine: '9호선' },
  { id: 'gimpo', name: '김포공항역', subwayLine: '공항철도·5호선·9호선' },
  { id: 'digital', name: '디지털미디어시티역', subwayLine: '6호선·경의중앙선·공항철도' },
];
