    ...
    <AnimatePresence>
      {(isOpen && rooms.length > 0) && (
        <>
          ...
          className="absolute bottom-0 left-0 right-0 z-40 h-48 w-full pointer-events-none"
          style={{
        ...
        />
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-0 right-0 z-50 w-full pb-8 pointer-events-none"
          >
