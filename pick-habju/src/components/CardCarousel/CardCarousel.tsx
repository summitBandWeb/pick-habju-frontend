  ...
  return (
    <AnimatePresence>
      {isOpen && rooms.length > 0 && (
        ...
        >
          {/* 내부 컨테이너: 이벤트 허용 및 중앙 정렬, 현재 Chevron의 기준점이 아니어서 relative 빼도 되지만 추가 UI 오버레이가 필요할 때 relative 필요 */}
          <div className="pointer-events-auto w-full max-w-[1200px] mx-auto relative">
            {/* ✅ 카드 프레임: 데스크탑은 카드 1장 폭, 모바일은 full. relative로 설정하여 Chevron의 기준점 */}
            <div className={isDesktop ? 'relative mx-auto w-100.5 overflow-visible' : 'relative w-full'}>
              {/* ✅ Chevron도 이 프레임 기준으로 양옆에 */}
